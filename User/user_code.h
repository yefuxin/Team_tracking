...
extern HX711 HX711_t;
void HX711_Init(void);

int HX711_GetInfo(void);
uint16_t HX711_Tare(uint16_t data, uint8_t times);
int HX711_Average_Value(uint8_t times);
float Get_NetWeight(uint8_t times);
long Get_Weight(void);
#define HX711_Buff  50u
#define GapValue 750.52f        //750.5f
...
#define HX711_SCK  PEout(4)// PE4
#define HX711_DOUT PEin(5)// PE5
